...
# st.set_page_config(page_title="Water Pollutants Predictor", layout="centered", page_icon="💧")
...
# st.markdown("<h1 style='text-align: center; color: navy;'>💧 Water Pollutants Predictor</h1>", unsafe_allow_html=True)
# st.markdown("<p style='text-align: center;'>Predict major water pollutant levels based on Year and Station ID using a machine learning model.</p>", unsafe_allow_html=True)
# st.markdown("---")
...
#     with col1:
#         year_input = st.number_input("Enter Year", min_value=2000, max_value=2100, value=2022, step=1)
...
#         # Align encoded input with model columns
#         for col in model_cols:
#             if col not in input_encoded.columns:
#                 input_encoded[col] = 0
#         input_encoded = input_encoded[model_cols]
...
#         st.success(f"✅ Prediction completed for Station ID '{station_id}' in {year_input}.")
